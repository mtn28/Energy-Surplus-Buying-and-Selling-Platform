...
export default function RegistarVendedor() {
                ...
                <div className="col-md-10">
                  <div className="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                    <div className="card-body">
                      ...
                      <h2 className="mb-2 text-center">Registo Vendedor</h2>
                      <p className="text-center">Registe os seus dados</p>
                      <form>
                        <div className="row">
                          <div className="col-lg-6">
                            <div className="form-group">
                              <label htmlFor="email" className="form-label">CPE de Produtos</label>
                        ...
                        <div className="d-flex justify-content-center">
                          <Link type="submit" className="btn btn-primary" onClick={() => sendUpdate()} to={`/dashboard_vendedor/${currentUser}`}>Registar</Link>
                        </div>
                      </form>
                    </div>
                  </div>
