...
export default function AnunciarVenda() {
  ...
  const [camppotenciainfraestrutura, setcamppotenciainfraestrutura] = useState("");
                ...
                <div className="col-md-12">
                  <div className="flex-wrap d-flex justify-content-between align-items-center">
                    <div>
                      ...
                      <p>Aqui poderá registar uma nova venda
                      </p>
                    </div>
                    <div>
                ...
                <div className="card-header mb-4 d-flex justify-content-between">
                  <form className="row g-3 needs-validation" noValidate>
                    <div className="col-md-6">
                      ...
                      <input type="text" value={campnomeuser} onChange={value =>
                        setcampnomeuser(value.target.value)} className="form-control" id="validationCustom01" defaultValue required />
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="form-group input-group">
                        <input type="text" className="form-control" value={campemail} onChange={value =>
                          setcampemail(value.target.value)} id="validationCustom02" defaultValue required />
                      </div>
                      <div className="invalid-feedback">
                        Insira um E-mail.
                      </div>
                    ...
                    <div className="col-md-6">
                      ...
                      <input type="text" className="form-control" value={campmorada} onChange={value =>
                        setcampmorada(value.target.value)} id="validationCustom01" defaultValue required />
                      <div className="invalid-feedback">
                        Insira um Nome.
                      </div>
                    </div>
                    <div className="col-md-6">
                      ...
                      <input type="text" className="form-control" value={camptelemovel} onChange={value =>
                        setcamptelemovel(value.target.value)} id="validationCustom02" defaultValue required />
                      <div className="invalid-feedback">
                        Insira um Telemóvel.
                      </div>
                    </div>
                    <div className="col-md-6">
                      <label htmlFor="validationCustom01" className="form-label">CPE de Produtor</label>
                      <input type="text" className="form-control" value={campcpe} onChange={value =>
                        setcampcpe(value.target.value)} id="validationCustom01" defaultValue required />
                      <div className="invalid-feedback">
                        Insira um CPE de Produto.
                      </div>
                    </div>
                    <div className="col-md-6">
                      <label htmlFor="validationCustom02" className="form-label">NIF</label>
                      <input type="text" className="form-control" value={campnif} onChange={value =>
                        setcampnif(value.target.value)} id="validationCustom02" defaultValue required />
                      <div className="invalid-feedback">
                        Insira um NIF.
                      </div>
                    </div>
            ...
            <div className="col-sm-12 col-lg-12">
              <div className="card">
                <div className="card-header d-flex justify-content-between">
                  <form className="row g-3 needs-validation" noValidate>
                    <div className="col-md-6">
                      <label htmlFor="validationCustom01" className="form-label">Preço por mês</label>
                      <input type="text" value={campprecomes} onChange={value =>
                        setcampprecomes(value.target.value)} className="form-control" id="validationCustom01" defaultValue required />
                      <div className="invalid-feedback">
                    ...
                    <div className="col-md-6">
                      <label htmlFor="validationCustom01" className="form-label">Potência da Infraestrutura</label>
                      <div className="form-group input-group">
                        <input type="text" className="form-control" value={camppotenciainfraestrutura} onChange={value =>
                          setcamppotenciainfraestrutura(value.target.value)} id="validationCustom01" defaultValue required />
                    ...
                    <div className="col-md-3">
                      <Link type="button" className="btn btn-primary" style={{ marginTop: '2em' }} to={`/infraestrutura/${currentUser}`}><a className="nav-link" aria-current="page"  >Adicionar Infraestrutura</a></Link>
                    </div>

                    <div className="col-md-6">
                      <label htmlFor="validationCustom01" className="form-label">Período de Contrato</label>
                      <div className="form-group input-group">
                        <input type="text" className="form-control" value={campduracaovenda} onChange={value =>
                          setcampduracaovenda(value.target.value)} id="validationCustom01" defaultValue required />
                        <span className="input-group-text" id="basic-addon1">meses</span>
                      </div>
                      <div className="invalid-feedback">
                    ...
                    <div className="col-12">
                      <Link to={`/dashboard_vendedor/${currentUser}`}><button className="btn btn-primary mb-4" onClick={() => SendSave()} type="submit">Criar Venda</button></Link>
                    </div>
                  </form>
                </div>
              </div>
